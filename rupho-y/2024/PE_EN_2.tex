...
Then the deflection angle will be written as
\[
  \psi = 2\left[\arcsin n\rho - \arcsin\rho\right],
\]
and the intensity of the scattered radiation as
\[
  \mathcal{J}(\psi) \equiv \frac{\rho \, \mathrm{d}\rho}{\sin\psi \, \mathrm{d}\psi}.
\]
Figure 6 shows a graph of the dependence $\mathcal{J}(\psi)$, obtained experimentally.
