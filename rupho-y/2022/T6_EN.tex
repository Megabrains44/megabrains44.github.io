...
\problembox{A3}{Let there be a diffraction grating in the $z = 0$ plane, the transmittance of which (in amplitude) has the form: $$ \textbackslash\{\}tau (x) = \textbackslash\{\}alpha + \textbackslash\{\}beta \textbackslash\{\}cos u x. $$ Перпендикулярно решетке на нее падает плоская электромагнитная волна с волновым числом $k$ и амплитудой $E_0$. Найдите выражение для комплексной амплитуды волны в плоскости с $z>0$. Use the result of the previous paragraph and the principle of superposition.}{0.70}
