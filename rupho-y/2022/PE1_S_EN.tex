...
\par\smallskip\noindent\textbf{Answer:} \[v=1.210,\quad w=3.064\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\frac{P_\mathrm{core}}{P_\mathrm{total}}=\frac{\varepsilon_xw(2v+\sin2v)}{2\varepsilon v\cos^2v+\varepsilon_xw(2v+\sin2v)}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[N=2.515\]
\end{solcard}

\begin{solcard}{B6}{Estimate at what $a_{\mathrm{cr}}$ the anisotropic waveguide will begin to lose to the conventional waveguide in terms of the share of energy transferred by the core.}{0.20}

The value is found approximately from the graph plotted at $\bf B4$.

\par\smallskip\noindent\textbf{Answer:} \[a_{\mathrm{cr}}=0.074\]
\end{solcard}
