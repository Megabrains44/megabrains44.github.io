...
\problembox{B6}{Find the total force $f$ acting per unit area of the membrane. Hydrostatic pressure can be neglected. Express your answer in terms of $e$, $D$, $\theta$, $\varepsilon$, $\varepsilon_0$, $k$ and $T$. \textit{Hint:} positive ions in water behave like an ideal gas and are locally in thermal equilibrium.}{1.50}
