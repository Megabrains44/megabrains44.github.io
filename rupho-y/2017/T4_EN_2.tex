...
\problembox{A1}{Consider the case of uniform compression deformation, when all stresses $\sigma_x$, $\sigma_y$, $\sigma_z$ are equal and negative (the block is subject to constant pressure from all sides $P= -\sigma_x=-\sigma_y=-\sigma_z$). The modulus of all-round compression is the value $K$, which is determined from the relation: \[\frac{\Delta V}{V}= - \frac{P}{K},\]where $V$ is the volume of the bar. Determine the bulk modulus $K$ through $E$ and $\mu$.}{1.00}

\problembox{A2}{Consider the case of uniaxial tensile deformation. In this case, a homogeneous rod can be stretched or compressed only in one direction, in the direction of the axis, which is taken to be the coordinate axis $x$. The transverse dimensions of the rod do not change! (the environment interferes with this). The unilateral tensile modulus is the value $E'$, which is determined from the relation: \[\frac{\Delta l_x}{l_x} =\frac{\sigma_x}{E'} .\]Determine the unilateral tensile modulus $E'$ through $E$ and $\mu$.}{1.00}
...
\problembox{B4}{Let us introduce the notation $I=\int \xi^2\, dS$. The quantity $I$ is called the moment of inertia of the cross section of the beam (by analogy with the moment of inertia in rotational dynamics, though $I$ here is a purely geometric quantity with dimension of length to the fourth power). Determine $I$ for the following beam cross-section shapes: (a) Rectangular section with width $w$ and height $h$. (b) Circular section of radius $r$. (c) Cylindrical pipe with inner radius $r_1$ and outer radius $r_2$.}{0.90}
