...
In this you can use the following values of fundamental constants:
\begin{itemize}
    \item $q = 1.602 \cdot 10^{-19}~\text{C}$ - electron charge modulus;
    \item $\varepsilon_0 = 8.854 \cdot 10^{-12} ~\text{F}/\text{m}$ - electrical constant;
    \item $\hbar =1.055 \cdot 10^{-34} ~\text{J} \cdot {s}$ - Planck’s constant;
    \item $c =2.998 \cdot 10^{8} ~\text{m}/\text{s} $ - speed of light in vacuum. The entire problem uses a right-handed coordinate system $xyz$.
\end{itemize}
...
Graph of the dependence of the rotation angle in graphene on the radiation frequency. Data from Crassee, I., Levallois, J., Walter, A. et al.  Nature Phys 7, 48-51 (2011). $1~\text{Hz} = 10^{12} ~\text{Hz}$
...
\problembox{C2}{After analyzing the given graph, determine the parameters $D_2$, $\tau$ and $\omega_B$ for the graphene sample under study. Magnetic field $B = 7~\text{T}$. When analyzing the graph, we can assume that $\omega_B \tau \gg 1$.}{1.50}
