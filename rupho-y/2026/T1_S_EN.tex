...
\par\smallskip\noindent\textbf{Answer:} \[F_C=\mu N+Rw\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[F_C=\dfrac{Rw}{1-\dfrac{\mu}{\mu\cos\theta+\sin\theta}}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[F=\dfrac{Rw}{(\sin\theta+\mu\cos\theta\cos\psi)-\mu\cos\psi}\sqrt{\mu^2\sin^2\psi+(\sin\theta+\mu\cos\theta\cos\psi)^2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[t_c=t\dfrac{\cos(\varphi-\alpha)}{\sin\varphi}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\varphi=\pi/4+\alpha/2\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\gamma=\dfrac{|\vec v_2-\vec v_1|}{|\vec v_1|}=\dfrac{\cos\alpha}{\cos(\varphi-\alpha)\sin\varphi}\]
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \[F_C=\dfrac{w(k\gamma t+R)}{1-\dfrac{\sin\beta\sin\varphi}{\cos(\varphi-\alpha)\cos(\beta-\alpha)}}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[F_C=\dfrac{wkt\cos\alpha\cos(\beta-\alpha)}{\sin\varphi(\cos(\varphi-\alpha)\cos(\beta-\alpha)-\sin\beta\sin\varphi)}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\varphi=\dfrac{\pi}{4}+\dfrac{\alpha-\beta}{2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[F\mathrm =Rw\mathrm -\mathrm d\Lambda/\mathrm da\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\varepsilon_{\min}=\sqrt{\dfrac{2R}{E t}}\]
\end{solcard}
