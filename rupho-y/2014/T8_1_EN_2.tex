...
\title{\textbf{Maximum on capacitor}}
\author{\normalsize Y14 (2014) --- English translation}
\date{}
\begin{document}
\maketitle

The circuit, consisting of two capacitors with capacitance $C_1$, $C_2$ and a coil with inductance $L$, is initially open. Capacitor $C_1$ is charged to a potential difference V, and capacitor $C_2$ remains uncharged.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{T8_1_EN_assets/fig1.jpg}
    \caption{Figure 1.}
\end{figure}

\problembox{A1}{Determine the maximum current in the circuit and the maximum voltage on the capacitor $C_2$ after closing the key.}{3.00}

\vspace{1em}
\noindent\textit{Source:} \url{https://pho.rs/p/3986}
