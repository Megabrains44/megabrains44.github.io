...
A spacecraft with mass $m=10^3~\text{кг}$ is in Earth's orbit around the Sun, far from Earth. To fly into Mars orbit, the vehicle opens its solar panels so that sunlight begins to exert pressure on them. The flight takes place in an ellipse tangent to the circular orbits of the Earth (radius $R_0=1.5 \cdot 10^8~\text{км}$) and Mars (radius $R_1=2.3⋅10^8~\text{км}$)
