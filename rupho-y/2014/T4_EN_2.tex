...
\problembox{A3}{What readings will be given by a wattmeter whose high-resistance winding (voltage winding) is connected directly to the network $220~\text{V}$, and the low-resistance (current) winding is connected between terminals $A$ and $B$?}{0}
