...
\title{\textbf{Bead Balance}}
\author{\normalsize Y12 (2012) --- English translation}
\date{}
\begin{document}
\maketitle

Beads with the same charges $q_1$, $q_2$, $q_3$ are put on a smooth thread of length $L$, connected with a loop.

\problembox{A1}{Find the distances between the charges in equilibrium.}{0}

\problembox{A2}{Find the potential energy of the system $U_\text{p}$ at equilibrium.}{0}

\problembox{A3}{Investigate the stability of the equilibrium position.}{0}

\vspace{1em}
\noindent\textit{Source:} \url{https://pho.rs/p/3978}
