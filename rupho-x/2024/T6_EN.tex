...
\problembox{B2}{Obtain exact expressions for the resonant cyclic frequency $\Omega_{рез}$ and the corresponding oscillation amplitude $A_{рез}$. Express your answers in terms of $\omega_0$, $\gamma$ and $A_0$. Consider $\gamma\sqrt{2}<\omega_0$.}{0.30}
...
\problembox{B3}{Derive approximate expressions for $\Omega_{рез}$, $A_{рез}$ and $\Delta{\omega}$ under weak damping ($\gamma\ll{\omega_0}$). Express your answers in terms of $A_0$, $\omega_0$ and $\gamma$.}{0.30}
