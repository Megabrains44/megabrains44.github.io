...
When moving in a circle $$ \frac{m v^2}{a} = \frac{GM_S m}{a^2}, \quad  v = \sqrt{\frac{G M_S}{a}}, $$hence period движения $$ T = \frac{2 \pi a}{v} = 2\pi \sqrt{\frac{a^3}{G M_S}}, $$а angular momentum $$ L= m v a = m \sqrt{G M_S a}. $$

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ T = \frac{2 \pi a}{v} = 2\pi \sqrt{\frac{a^3}{G M_S}} = 0.24 ~\text{gода}, \quad L= m v a = m \sqrt{G M_S a} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ g_z = -  \frac{G M z }{R^3} $$
\end{solcard}
...
The force acting on Mercury from the side of the ring is equal to $$ F_r = m g_r = \frac{GMm}{2 R^3} r, $$integrating let us find potentialьную энергию $$ V_1 = - \frac{GM m}{4 R^3}r^2. $$The potential energy of interaction with the Sun must be added to it.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ V = - \frac{GM m}{4 R^3}r^2 - \frac{GM_S m}{r} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \frac{dr}{dt} = - \frac{L}{m} u' $$
\end{solcard}
...
Kinetic energy $$ T = \frac{m v^2}{2} = \frac{m \dot{r}^2}{2 } + \frac{m v_\theta^2}{2} = \frac{L^2}{2 m} u^{\prime 2} + \frac{L^2}{2 m r^2}, $$$$ T = \frac{L^2}{2 m} (u^{\prime 2} + u^2). $$К ней нужно добавить potentialьную энергию $V(r) = V(1/u)$.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ E =  \frac{L^2}{2 m} (u^{\prime 2} + u^2) + V \left( \frac{1}{u}\right) $$
\end{solcard}
...
Let us substitute the expression for potential energy: $$ E = \frac{L^2}{2 m} (u^{\prime 2} + u^2) - \frac{GM m}{4 R^3}\frac{1}{u^2} - GM_S m u. $$Differentiating, we get $$ E' = 0 = \frac{L^2}{m} (u' u'' + u u') + \frac{G M m}{2 R^3} \frac{u'}{u^3} - G M_S m u'. $$Сокращая на $u'$ (since в общем сrayае $u' = 0$ is not a solution to the equations of motion), we find

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ u'' = - u + \frac{G M_S m^2 }{L^2} - \frac{GM m^2}{2 R^3 L^2} \frac{1}{u^3} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ - \frac{1}{a} + \frac{G M_S m^2 }{L^2}- \frac{GM m^2}{2 R^3 L^2} a^3 = 0 $$
\end{solcard}
...
Substitute $u = u_0 + \delta u$ into the equation and expand to first order in $\delta u$: $$ \delta u '' = - u_0 - \delta u+  \frac{G M_S m^2 }{L^2} - \frac{GM m^2}{2 R^3 L^2} \left(\frac{1}{u_0^3}  - \frac{3 \delta u}{u_0^4} \right). $$Не зависящие от $\delta u$ terms сокращаются в силу уравнения from предыдущего partа. Substituting $u_0 = 1/a$, we obtain

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \delta u'' = - \left( 1 - \frac{3 G M m^2}{2 R^3 L^2} a^4\right) \delta u $$
\end{solcard}
...
The field of the ring corresponds to the term containing $M$. Discarding it, we obtain $$ \delta u ''  = - \delta u. $$Отметим, что это equation является точным, since if пренебречь вкладом кольца, equation на $u$ будет линейным. Его solution, максимальное for/at $\theta = 0$, имеет вид $$ \delta u = A \cos \theta, \quad A > 0. $$Then полное solution $$ u = \frac{1}{a} \left(1 + a A \cos \theta \right) = \frac{1}{a} \left(1 + e \cos \theta \right), $$therefore coefficient перед косинусом $$ A = \frac{e}{a}. $$Since $u(\theta) = u(\theta + 2\pi)$, the orbit is closed.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \delta u = \frac{e}{a } \cos \theta. $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \delta u = \frac{e}{a} \cos \left( \theta\sqrt{1 - \frac{3  M a^3 }{2 M_S R^3 } }\right) $$
\end{solcard}
...
Mercury is at perihelion (i.e., its distance to the Sun is minimal) when the value of $u$ is maximum, that is, $$ \theta = \frac{2\pi n}{\sqrt{1 - \dfrac{3  M a^3 }{2 M_S R^3 }} }. $$В частности, изменение положения перигелия за один оборот $$ \delta \theta  = \frac{2\pi }{\sqrt{1 - \dfrac{3  M a^3 }{2 M_S R^3 }} } - 2\pi \approx 2\pi \left( 1 + \dfrac{3  M a^3 }{4 M_S R^3 }\right) - 2\pi = \frac{3 \pi }{2} \frac{M a^3}{M_S R^3}. $$Since $\delta \theta > 0$, that is перигелий отстоит от предыдущего на angle больше $2\pi$, the direction of rotation of the perihelion coincides with the direction of movement of Mercury.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \delta \theta  = \frac{3 \pi }{2} \frac{M a^3}{M_S R^3} $$
\end{solcard}

\begin{solcard}{С6}{The table shows the orbital radii (we consider them approximately equal to the semimajor axes) and masses for the planets of the Solar System. For each of them, calculate the shift of the perihelion of Mercury per revolution around the Sun. In all cases, you can assume that the radius of the planet’s orbit is much greater than the radius of Mercury’s orbit. Express your answer in arcseconds. Indicate the two planets that make the greatest contribution to precession. Note: An arcsecond is a unit of measurement of angles that is 1/3600 of a degree.}{0.70}
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} Planet Contribution to $\delta \theta$, '' Venus $0.3669$ Earth $0.1677$ Mars $0.0051$ Jupiter $0.3806$ Saturn $0.0183$ Uranus $3.47\cdot 10^{-4} $ Neptune $1.06 \cdot 10^{-4}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \Delta \theta = 391'' \text{ за sтоLетие} $$
\end{solcard}

\begin{solcard}{D1}{Let Mercury move in the central field, the force acting on it is equal to $\vec{F}  = F_r \vec{e}_r$. Show that the derivative is $$ \frac{d}{dt} \left( \vec{v} \times \vec{L}\right) = B \frac{d}{d t} \vec{e}_r. $$Find coefficient $B$, выtimesandте его via/through $r$, $m$, $F_r$.}{0.80}

We use Newton's second law $$ m \vec{a} = m \frac{d}{dt} \vec{v}  = \vec{F} = F_r \vec{e}_r, $$а also expression for momentа momentumа via/through угловую velocity Меркурия $$ \vec{L}  = m r^2 \vec{\omega}. $$Then требуемая производная $$ \frac{d}{dt} \left( \vec{v} \times \vec{L}\right) = \vec{a} \times \vec{L} = \frac{F_r}{m} \vec{e}_r \times m r^2 \vec{\omega}= - r^2F_r \vec{\omega} \times \vec{e}_r = - r^2 F_r \frac{d \vec{e}_r}{dt}. $$Тот же result можно поrayandть and более прямолинейным вычислением $$ \frac{d}{dt} \left( \vec{v} \times \vec{L}\right) = \frac{F_r}{m} \vec{e}_r \times \vec{L}  = \frac{F_r}{m} \vec{e}_r \times m \left[\vec{r} \times \vec{v} \right]. $$Раскрывая двойное vectorное произведение, we get $$ \frac{d}{dt} \left( \vec{v} \times \vec{L}\right) = F_r \left(\vec{r} (\vec{e}_r \vec{v}) - \vec{v} (\vec{r} \vec{e}_r) \right)= F_r \left( \frac{(\vec{r} \vec{v}) \vec{r}}{r} - r \vec{v}\right) = F_r r^2\left( \frac{(\vec{r} \vec{v}) \vec{r}}{r^3} - \frac{\vec{v}}{r}\right) . $$Let us find теперь производную $\vec{e}_r$: $$ \frac{d}{dt} \vec{e}_r = \frac{d}{dt} \left( \frac{\vec{r}}{r}\right) = \frac{\vec{v}}{r} - \vec{r} \frac{1}{r^2} \frac{d r}{dt} = \frac{\vec{v}}{r} - \frac{\vec{r} (\vec{v} \vec{r})}{r^3}. $$Comparing these expressions, we return to the same result

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \frac{d}{dt} \left( \vec{v} \times \vec{L}\right)  = - r^2 F_r \frac{d \vec{e}_r}{dt}, \quad B = - r^2 F_r $$
\end{solcard}
...
Using the relation from the previous paragraph, we differentiate the Laplace vector and obtain $$ \frac{d \vec{A}}{dt} = \frac{d}{dt} \left( \vec{v} \times \vec{L}\right) - G M_S m \frac{d \vec{e}_r}{dt} = \left( -r^2 F_r - G M_S m\right) \frac{d \vec{e}_r}{dt}. $$Force, действующая на Меркурий, equals $$ F_r = - \frac{GM_S m}{r^2 } + \frac{GMm}{2 R^3} r. $$The first term in the force cancels with the second term from the definition of the Laplace vector. Therefore, when moving under the influence of gravity towards the Sun, the Laplace vector is conserved. Taking into account the ring we obtain

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \frac{d \vec{A}}{dt} = - \frac{GMm}{2 R^3} r^3\frac{d \vec{e}_r}{dt} $$
\end{solcard}
...
From the previous result it follows $$ d \vec{A} = - \frac{GMm}{2 R^3} r^3 d \vec{e}_r, $$differentiating по углу, we get $$ \frac{d \vec{A}}{d\theta} = - \frac{GMm}{2 R^3} r^3\frac{d \vec{e}_r}{d\theta}. $$Проекции единичного vectorа $\vec{e}_r$ на координатные оси $$ e_{rx} = \cos \theta, \quad e_{r y} = \sin \theta, $$а их производные $$ \frac{d e_{rx}}{d\theta}  = - \sin\theta, \quad \frac{d e_{ry}}{d\theta} = \cos \theta. $$Then for the Laplace vector

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \frac{d A_x}{d\theta} =  \frac{GMm}{2 R^3} r^3 \sin \theta, \quad \frac{d A_y}{d\theta} =   - \frac{GMm}{2 R^3} r^3 \cos \theta $$
\end{solcard}
...
When moving along an elliptical orbit $$ r = \frac{p} {1 + e \cos \theta}, $$where $p = a(1 - e^2)$ – parameter эллипса. Then производные компонент vectorа Лапласа имеют вид $$ \frac{d A_x}{d\theta} =  \frac{GMm}{2 R^3} \frac{p^3}{(1 + e\cos \theta)^3} \sin \theta, \quad \frac{d A_y}{d\theta} =   - \frac{GMm}{2 R^3} \frac{p^3}{(1 + e\cos \theta)^3} \cos \theta. $$Integrating по углу от $0$ до $2 \pi $ (or что то же самое, от $-\pi$ до $\pi$, since функции periodandчные), we get изменение vectorа Лапласа за period: $$ \Delta A_x = \frac{GM mp^3}{2 R^3} \int_{-\pi}^{\pi} \frac{\sin \theta \, d \theta}{(1 + e \cos \theta)^3} = 0, $$since function под интегралом нечетная, $$ \Delta A_y =- \frac{GM mp^3}{2 R^3} \int_{0}^{2 \pi} \frac{\cos \theta \, d \theta}{(1 + e \cos \theta)^3} = \frac{GM mp^3}{2 R^3} \frac{3 \pi e}{(1- e^2)^{5/2}}. $$The integral from the condition was used here. Substituting the formula for the parameter, we get

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \Delta A_x = 0, \quad \Delta A_y = \frac{3 \pi GM m a^3}{2 R^3}  e(1- e^2)^{1/2}. $$
\end{solcard}
...
The Laplace vector is directed along the $x$ axis, so the change in the Laplace vector is perpendicular to it. This means, to a first approximation, its length does not change, but it itself rotates by an angle $$ \Delta \theta = \frac{\Delta A_y}{A} = \frac{3\pi }{2} \frac{M a^3}{M_S R^3} (1 - e^2)^{1/2}. $$Since vector Лапласа направлен к перигелию, его angle поворота equals смещению перигелия. Точный answer отличается от for/atближенного answerа from части C только множителем $(1 - e^2)^{1/2} \approx 1 - e^2/2$. From-за этой поправки answer уменьшится  на $e^2/2 \approx 0.02 = 2\text{%}$.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \Delta \theta =  \frac{3\pi }{2} \frac{M a^3}{M_S R^3} (1 - e^2)^{1/2}. $$ Angle поворота перигелия уменьшится на $2 \text{%}$.
\end{solcard}
