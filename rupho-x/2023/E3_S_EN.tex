...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $B(x)=\cfrac{\mu_0}{4\pi}\cfrac{2m}{x^3}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $x_{crit}\approx 35~\text{mm}$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $n = 2.02 \approx 2$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $M=\cfrac{2\beta}{\mu_0 R^2 L}=7.81\cdot10^5~\text{A}/\text{m}$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $h(d)=(2.5 \pm 0.5)~\text{mm} \approx const$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} Graphite is diamagnetic.
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $F(y) = \cfrac{\pi r^2l}{\mu_0} \cfrac{\chi}{\chi+2} \cdot \cfrac{d}{dy} B^2 (y)$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $F(u)=-\cfrac{\chi}{\chi+2} \cfrac{\pi r^2l \mu_0 M^2R^4}{a^5} \cfrac{4u(1-u^2)(3-u^2)}{(1+u^2)^5}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $u=\cfrac{R-h}{a}=0.435$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\chi=(-2.6\pm0.7)\cdot 10^{-4}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\alpha_{crit}\approx0.0175~\text{radиан}$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\Delta U =2.4~\text{mJ}/\text{kg}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $l_{min} =8~\text{mm}$ – the stylus hangs crookedly or stands across the magnets. $l_{max} =28~\text{mm}$ – the stylus jumps out of its equilibrium position and crashes into the support of the stand.
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $z_{max} =\cfrac{l_{max}}{2}=14~\text{mm}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $c_2 =9.3~1/\text{s}^2$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $T(l)=\cfrac{2\pi}{\sqrt{2c_2+c_4l^2}}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $c_2 = 23~1/\text{s}^2$, $c_4 = -4.51\cdot 10^4~\cfrac{1}{\text{m}^2 \text{s}^2}$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\gamma=0.19~1/\text{s}$
\begin{figure}[H]
  \centering
