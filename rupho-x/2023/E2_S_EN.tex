...
\par\smallskip\noindent\textbf{Answer:} $F$ can be obtained from the graph in four ways. For the red line, from the free term equal to $FH$ it follows that $F=17.0~\text{cm}$, from the slope coefficient equal to $F/D$ it follows that $F=15.7~\text{cm}$. For the blue line, the free term equal to $FH$ implies that $F=17.3~\text{cm}$, and the slope coefficient equal to $-F/D$ implies that $F=17.2~\text{cm}$.
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} $L_F$ Border blue at $ a < a_0$, red at $a > a0$ $L_F$ Border red at $ a < a_0$, blue at $a > a0$ $\times$ $L_f$ Border blue at $ a < a_0$, red at $a > a0$ $L_f$ Red border for $ a < a_0$, blue for $a > a0$ $\times$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} $L_F$ $n_b > n_r$ $\times$ $L_F$ $n_r > n_b$ $L_f$ $n_b > n_r$ $\times$ $L_f$ $n_r > n_b$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} From the slope coefficient of the graph $H_A=0.37~\text{cm}$. Let's measure the ratio $\frac{H_A}{W_A}$ from the enlarged image: $\frac{H_A}{W_A} = \frac{3.1~\text{cm}}{1.0~\text{cm}}$, which means $W_A=0.12~\text{cm}$.
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} Let's look at the image on the screen enlarged with a lens, and we will also use the aperture to reduce blur due to aberrations. \[N_A = 18\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} The slope coefficient of the graph is $k=0.35~\text{cm}$, which fully corresponds to $H_A$ obtained in other points.
\begin{figure}[H]
  \centering
