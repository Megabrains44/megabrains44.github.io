...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$\vec{p}=4\pi\epsilon_0R^3\vec{E}_0 $$
\end{solcard}

\begin{solcard}{A2}{Let the ball be located in an electric field directed along the $z$ axis, the intensity of which varies according to the law: $$\vec{E}\approx{\left(E_0+kz\right)\vec{e}_z} $$ where $E_0$ and $k$ — известные величины, moreover $kR\ll{E_0}$. Find силу $F_z$, действующую на ball/sphere. Answer выtimesandте via/through $E_0$, $k$, $R$ and электрическую постоянную $\epsilon_0$.}{0.50}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$F_z=4\pi{R}^3\epsilon_0E_0k $$
\end{solcard}

\begin{solcard}{A3}{Find the magnitude of the electric field of the wire $E_\text{п}$ at a distance $r$ from it. Express your answer in terms of $\lambda$, $r$ and the electric constant $\varepsilon_0$.}{0.20}

From Gauss's theorem we have: $$2\pi rLE_\text{п}=\cfrac{q}{\epsilon_0}=\cfrac{\lambda L}{\epsilon_0} $$ whence:

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$E_\text{п}=\cfrac{\lambda}{2\pi\epsilon_0 r} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The force of attraction is: $$F=\cfrac{\lambda^2R^3}{\pi\epsilon_0r^3} $$
\end{solcard}

\begin{solcard}{A5}{Show that the mechanical potential energy $W_p$ of a ball in the field of a wire at a distance $r$ between the wire and the center of the ball is equal to: $$W_p=-\cfrac{A}{r^2} $$ Find $A$. Answer выtimesandте via/through $\lambda$, $R$ and электрическую постоянную $\varepsilon_0$.}{0.40}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$A=\cfrac{\lambda^2R^3}{2\pi\epsilon_0} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$r_{min}=\sqrt{b^2-\cfrac{2A}{mv^2_0}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$v_{crit}=\cfrac{1}{b}\sqrt{\cfrac{2A}{m}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$u'=-\cfrac{\dot{r}}{r^2\dot{\varphi}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$\cfrac{mv^2_0b^2}{2}\left(u'^2+u^2\right)-Au^2=E=\cfrac{mv^2_0}{2} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$u(\varphi)=\cfrac{1}{b\sqrt{1-\cfrac{2A}{mv^2_0b^2}}}\sin\left(\varphi\sqrt{1-\cfrac{2A}{mv^2_0b^2}}\right) $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$v_1=\cfrac{2\lambda R}{b}\sqrt{\cfrac{R}{3\pi\epsilon_0m}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$S=\cfrac{R^2}{L}\quad q_2=\cfrac{q_1R}{L} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$dq_1=\cfrac{\lambda r}{\cos^2\alpha}d\alpha $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The force of attraction is $$dF=\cfrac{\lambda^2R^3}{2\pi\epsilon_0r^3}\cfrac{\cos\alpha d\alpha}{1-\cfrac{R^2}{r^2}+\cfrac{R^2}{r^2}\sin^2\alpha} $$
\end{solcard}

\begin{solcard}{D4}{Find the magnitude and direction of the total force of interaction between the ball and the wire $F_\text{поLн}$. Express your answer in terms of $\lambda$, $R$, $\theta$ and the electric constant $\epsilon_0$.}{1.00}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The force of attraction is $$F=\cfrac{\lambda^2}{\pi\epsilon_0}\cfrac{\sin^2\theta\cdot{\theta}}{\cos\theta} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$W_p(\theta)=-\cfrac{\lambda^2R\theta^2}{2\pi\epsilon_0} $$
\end{solcard}

\begin{solcard}{D6}{What speed $v_\text{sт}$ will an uncharged metal ball of radius $R$ and mass $m$ have when colliding with a wire if it is released from infinity without an initial speed? Express your answer in terms of $\lambda$, $R$, $m$ and the electric constant $\varepsilon_0$.}{0.30}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$v=\cfrac{\pi\lambda}{2}\sqrt{\cfrac{R}{\pi\epsilon_0m}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$\dot{r}^2=v^2_0-v^2_0\cfrac{b^2}{R^2}\sin^2\theta+\cfrac{\lambda^2R}{\pi\epsilon_0m}\theta^2 $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$\left(\cfrac{b^2\sin^2\theta_{max}}{R^2}-1\right)=\cfrac{\lambda^2R\theta^2_{max}}{mv^2_0\pi\epsilon_0}\qquad\cfrac{b^2\sin2\theta_{max}}{R^2}=\cfrac{2\lambda^2R\theta_{max}}{mv^2_0\pi\epsilon_0} $$
\end{solcard}

\begin{solcard}{E4}{Find $v_{crit1}$, $v_{crit2}$ and $v_{crit3}$ corresponding to the following values ​​of $b$ : $$b_1=20R\quad b_2=3R\quad b_3=1{,}1R $$ Answerы выtimesandте via/through $m, R, \lambda$ and электрическую постоянную $\varepsilon_0$.}{1.20}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$v_{crit1}\approx{5{,}15\cdot{10^{-2}}\lambda\sqrt{\cfrac{R}{\pi\epsilon_0m}}}\quad v_{crit2}\approx{3{,}15\cdot{10^{-1}}\lambda\sqrt{\cfrac{R}{\pi\epsilon_0m}}}\quad v_{crit3}\approx{3{,}30\lambda\sqrt{\cfrac{R}{\pi\epsilon_0m}}} $$
\end{solcard}
