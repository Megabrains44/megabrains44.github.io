...
\begin{solcard}{A1}{Let at the initial moment of time $t = 0$ the current through the contact be equal to zero. At this moment, voltage $V$ was applied to the contact.  Determine the dependence of the current on time $I(t)$. Express your answer using $\Phi_0$, $V$, $I_c$, $R$.}{0.50}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$I = \dfrac{V}{R} + I_c \sin \left( \dfrac{2\pi}{\Phi_0}V t\right)$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$I = I_c \sin \varphi + \dfrac{\Phi_0}{2 \pi R} \dot{\varphi}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \dot{V}^2 = \left(\frac{2 \pi R}{\Phi_0} \right)^2 V^2 \left(I_c^2 -  \left(I - \frac{V}{R} \right)^2\right) $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \dot{u}^2 = \left(\frac{2 \pi R}{\Phi_0} \right)^2\left(I_c^2 u^2 - \left(I u - \frac{1}{R} \right) ^2\right) $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \omega = \frac{2\pi R}{\Phi_0} \sqrt{I^2 - I_0^2}; \quad u_0 = \frac{I}{R (I^2 - I_c^2)}; \quad A =  \frac{I_c}{R(I^2 - I_c^2)}. $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ V = \frac{R(I^2 - I_c^2)}{I + I_c \cos \left(\dfrac{2\pi R}{\Phi_0} \sqrt{I^2 - I_0^2} t \right)} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} Graph for case $I = 1.1 I_c$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ V = R \sqrt{I^2 - I_c^2} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ I = I_c \sin \varphi + \frac{\Phi_0}{2\pi R} \dot{\varphi} + \frac{\Phi_0 C}{2\pi} \ddot{\varphi} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \omega_p = \sqrt{ \frac{2 \pi I_c }{\Phi_0 C}- \frac{1}{4 R^2 C^2}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ Q = R \sqrt{\frac{2 eI_c C}{\hbar}}, \quad C \ge \frac{\Phi_0}{8 \pi R^2 I_c}. $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ I_0 = \sqrt{I_{ac}^2 + I_{bc}^2 + 2 I_{ac} I_{bc} \cos \left( 2\pi \frac{\Phi}{\Phi_0}\right)} $$$$ \cos \varphi_a = - \frac{I_{bc} \sin \left( 2\pi \frac{\Phi}{\Phi_0}\right)}{ \sqrt{I_{ac}^2 + I_{bc}^2 + 2 I_{ac} I_{bc} \cos \left( 2\pi \frac{\Phi}{\Phi_0}\right)}} $$$$ \cos \varphi_b =  \frac{I_{ac} \sin \left( 2\pi \frac{\Phi}{\Phi_0}\right)}{ \sqrt{I_{ac}^2 + I_{bc}^2 + 2 I_{ac} I_{bc} \cos \left( 2\pi \frac{\Phi}{\Phi_0}\right)}} $$
\end{solcard}
