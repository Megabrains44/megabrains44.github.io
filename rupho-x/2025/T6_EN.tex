...
\begin{figure}[H]
    ...
    \caption{Fig. 3.}
\end{figure}
\problembox{A1}{Let the side of the square hole be $a = 1 ~\text{м}$. Find the characteristic angular dimension $\beta$ of the hole as viewed from the screen. Compare it to the angular size of the Sun.}{0.20}
\problembox{A2}{Let now the side of the square hole be $a = 5 ~\text{мм}$. Find the characteristic angular dimension $\beta$ of the hole as viewed from the screen. Compare it to the angular size of the Sun.}{0.20}
\problembox{A3}{In the answer sheets, qualitatively give the image of the Sun at $a = 1~\text{м}$. Please indicate the dimensions that characterize this image.}{0.30}
\problembox{A4}{In the answer sheets, qualitatively give the image of the Sun at $a = 5~мм$. Please indicate the dimensions that characterize this image.}{0.50}
...
\problembox{D4}{Show that the image of the horizon on the screen is described by the following equation: $$\cfrac{Y^2}{A^2} - \cfrac{X^2}{B^2} = 1,$$ где $A, B > 0$. Выразите $A$ и $B$ через $L$ и $\theta$. Примечание: следующее выражение может оказаться полезным: $$\cfrac{1}{\cos^2\varphi} = 1+\tan^2\varphi.$$}{0.70}
