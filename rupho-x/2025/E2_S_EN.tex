...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $I,~\mathrm{\mu{}A}$ $N$ $\alpha$ 118.10 0 1.000 58.10 1 0.483 32.30 2 0.260 16.10 3 0.121 9.60 4 0.065 6.30 5 0.036
\end{solcard}

\begin{solcard}{А3}{Position one cuvette with $2.8~\mathrm{mL}$ water so that the laser beam passes through its walls normally. Remove the dependence of the transmittance coefficient $\alpha$ on the volume $\Delta V$ of the added milk solution in the range $\Delta V \leq 1~\mathrm{mL}$.}{0.50}
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\Delta V,~\mathrm{mL}$ $I,~\mathrm{\mu{}A}$ $\alpha$ 0 262 1.000 0.1 139.7 0.530 0.2 81.6 0.307 0.3 48.9 0.182 0.4 29.4 0.107 0.5 18.6 0.065 0.6 13.6 0.046 0.7 9.8 0.031 0.8 7.0 0.021 0.9 5.6 0.015
\end{solcard}

\begin{solcard}{А4}{Let a parallel beam of light fall on a layer of milk solution with a thickness of $L$ and a micelle concentration of $n$. Express the transmittance $\alpha$ in terms of $L$, $n$ and the effective scattering area $\delta S$ of the micelles.}{0.30}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[ \alpha = e^{- L n \, \delta S}\]
\end{solcard}
...
\begin{solcard}{A7}{Assuming that the radius of the micelles is $r_0=60~\text{nm}$, find the number of $P$ casein molecules in each of them. The molar mass of a casein molecule is $23~kg/моль$ (protein is a high-molecular organic substance, therefore it has a gigantic molar mass by the standards of inorganic compounds).}{0.30}

According to the condition, the effective scattering area of micelles is equal to: 6.5 \textbackslash{}cdot 10^{22}~\textbackslash{}text{m}^{-3}$ и $P=n_\textbackslash{}mathrm{Cas}/n_0$.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$P = 1.8 \cdot 10^3$$
\end{solcard}

\begin{solcard}{B1}{Remove the dependence of the steady-state transmittance $\alpha$ on the acid concentration in the solution $c$. Measure the concentration of $c$ in $г$ acid per $1~\mathrm{L}$ solution. At a concentration of $c_\text{крит}$, measure the value $\alpha$ and after $1~\mathrm{m}ин$ after adding a portion of acid and after $20~\mathrm{m}ин$.}{0.90}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $\Delta V,~\mathrm{mL}$ $I, мкА$ $\alpha$ 0 100.2 0.297 0.1 106.2 0.315 0.2 113.1 0.336 0.3 120.2 0.357 0.4 126.6 0.376 0.5 133 0.395 0.6 137.1 0.407 0.7 145.8 0.433 0.8 150.5 0.447 0.9 151.1 0.448 1.0 151 0.448 0.1 140 0.415 0.2 105.8 0.314
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The resulting graph only allows us to estimate the value of $k$ in order of magnitude - this is due to the small step in concentration and the absence of additional methods for measuring the micelle radius. However, $k_\textbf{B6}=0.23 \cdot 10^{-6}~\text{nm}$ and therefore $k=0.9~\text{N}/\text{m}$.
\begin{figure}[H]
  \centering
