...
\problembox{A2}{Position 5 cuvettes with $2.8~мл$ water so that the laser beam passes through them and falls normally on their walls. By sequentially adding $0.1~мл$ milk solution to each of the cuvettes, remove the dependence of the transmittance $\alpha$ on the number of cuvettes $N$ in which the milk solution is added. Sketch the optical design used for $N=3$.}{0.50}
...
\problembox{A3}{Position one cuvette with $2.8~мл$ water so that the laser beam passes through its walls normally. Remove the dependence of the transmittance coefficient $\alpha$ on the volume $\Delta V$ of the added milk solution in the range $\Delta V \leq 1~мл$.}{0.50}
...
\problembox{A7}{Assuming that the radius of the micelles is $r_0=60~\text{нм}$, find the number of molecules $P$ of casein in each of them. The molar mass of a casein molecule is equal to $23~кг/моль$ (protein is a high-molecular organic substance, therefore it has a gigantic molar mass by the standards of inorganic compounds).}{0.30}
...
\problembox{B1}{Remove the dependence of the steady-state transmittance $\alpha$ on the acid concentration in the solution $c$. Measure the concentration of $c$ in $г$ acid per $1~л$ solution. At concentration $c_\text{крит}$, measure the value $\alpha$ and through $1~мин$ after adding a portion of acid and through $20~мин$.}{0.90}
