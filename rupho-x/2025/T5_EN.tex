...
\problembox{A2}{Assume that the extracellular solution is $\mathrm{NaCl}$ with a concentration of $440~ммоль/л$. Relative dielectric constant of water $\varepsilon= 81$, $T = 310~К$. Calculate $\lambda$ in nm and compare your answer with the cell membrane thickness $d\approx 5~ нм$.}{0.30}
...
\problembox{C4}{For the neuron under consideration, $a=20~мкм$, $g_\mathrm{tot}=5~Ом^{-1}\cdot м^{-2}$, thickness and dielectric constant of the cell membrane $d=5~нм$ and $\varepsilon=7$, conductance $\sigma=3~Ом^{-1}\cdot м^{-1}$. Estimate the distance and time scales over which a neural signal propagates.}{0.40}
