...
From symmetry, the electric field is directed radially. Then its value can be found from Gauss’s theorem: $$ E(r)=\dfrac{\kappa}{2\pi\varepsilon_0 r}. $$Integrating, we get expression for potentialа: $$ \varphi(r)=-\int\limits_{a}^{r} E(r) dr =-\dfrac{\kappa}{2\pi\varepsilon_0 }\ln{\frac{r}{a}}. $$Here $a$ is the distance from which the potential is measured.

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \varphi(r)=-\dfrac{\kappa}{2\pi\varepsilon_0 }\ln{\frac{r}{a}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\vec E(r)=\cfrac{1}{2\pi\varepsilon_0r^2}\left( 2\cfrac{\vec{r}(\vec{r}\vec{p})}{r^2} - \vec{p}\right)\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\vec p=2\pi\varepsilon_0\vec E_0R^2\cfrac{\varepsilon_1-\varepsilon_2}{\varepsilon_1+\varepsilon_2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} Inside the cylinder ($r \leq R$): $$\vec{E}_1 = \frac{2\varepsilon_2}{\varepsilon_1 + \varepsilon_2} \vec{E}_0;$$снаружи cylinderа ($r > R$): \[\vec{E} = \vec{E}_0 + \frac{\varepsilon_1 - \varepsilon_2}{\varepsilon_1 + \varepsilon_2} R^2\left(\frac{2(\vec{r}\vec{E}_0) \vec{r}}{r^4}-\dfrac{ \vec{E}_0}{r^2}\right).\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\sigma_f = 2\varepsilon_0E_0\cfrac{\varepsilon_2\lambda_1 - \varepsilon_1\lambda_2}{\lambda_1 + \lambda_2}\cos\theta\]\[\vec{j_1} = \frac{2\lambda_1\lambda_2}{\lambda_1 + \lambda_2} \vec{E}_0\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$\tau_2 = \cfrac{\varepsilon_0\varepsilon_2}{\lambda_2}\ln(2)$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[E_{\tau1} = E_{\tau2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[i(\theta) = R\omega\sigma_f(\theta)\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[i(\theta_0) - i(\theta_0 + d\theta) + R(j_{1n} -j_{2n})d\theta = 0\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[-\omega\dfrac{\partial \sigma_f}{\partial \theta}+ \lambda_1E_{1n} - \lambda_2E_{2n} = 0\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\left(\lambda_1+\omega\varepsilon_1\varepsilon_0\dfrac{\partial}{\partial \theta}\right)E_{1n}=\left(\lambda_2+\omega\varepsilon_2\varepsilon_0\dfrac{\partial}{\partial \theta}\right)E_{2n}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\varepsilon_1^*=\varepsilon_1+\dfrac{i\lambda_1}{\omega\varepsilon_0}\]\[\varepsilon_2^*=\varepsilon_2+\dfrac{i\lambda_2}{\omega\varepsilon_0}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\vec p^*=2\pi\varepsilon_0\vec{E}_0^*R^2\dfrac{\varepsilon_1-\varepsilon_2+\dfrac{i(\lambda_1-\lambda_2)}{\omega\varepsilon_0}}{\varepsilon_1+\varepsilon_2+\dfrac{i(\lambda_1+\lambda_2)}{\omega\varepsilon_0}}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[p_x=2\pi R^2\varepsilon_0E_0\dfrac{\omega^2\varepsilon_0^2(\varepsilon_1^2-\varepsilon_2^2)+\lambda_1^2-\lambda_2^2 }{(\sigma_1 + \sigma_2)^2 + (\omega \varepsilon_0)^2 (\varepsilon_1 + \varepsilon_2)^2},\]\[p_y=-4\pi\omega R^2\varepsilon_0^2E_0\dfrac{(\varepsilon_1\lambda_2-\varepsilon_2\lambda_1) }{(\lambda_1 + \lambda_2)^2 + (\omega \varepsilon_0)^2 (\varepsilon_1 + \varepsilon_2)^2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[M_z=4\pi\omega LR^2\varepsilon_0^2E_0^2\dfrac{(\varepsilon_1\lambda_2-\varepsilon_2\lambda_1) }{(\lambda_1 + \lambda_2)^2 + (\omega \varepsilon_0)^2 (\varepsilon_1 + \varepsilon_2)^2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\varepsilon_2/\lambda_2<\varepsilon_1/\lambda_1\]
\end{solcard}
...
To find the remaining powers, we use the method of dimensions: \[Н\cdot м=(Н\cdot м^{-2}\cdot с)^a\cdot c^{-b}\cdot м^{c}\cdot м\]Equating the coefficients before Newtons, we obtain:
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[d=1\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[M =\tau_{\theta z}\cdot S\cdot r= 2\pi \eta r^3L \frac{\partial \omega}{\partial r}\]
\end{solcard}

\begin{solcard}{C3}{Determine the coefficient $\alpha$ in the formula for the moment of force $M_{\eta}$.}{1.20}

Since each fluid element rotates uniformly, the moment acting on the outer side of the fluid layer will be equal to the moment with which this fluid layer acts on the layer below it. That is, $M = M_\eta = \operatorname{const}$. Let's separate the variables and integrate this equation: \[\cfrac{M_\eta}{2\pi \eta L} \cfrac{dr}{r^3}=  d\omega\]Since $\omega(r\to\infty)=0$, and $\omega(R) = \omega_0$, then: \[\cfrac{M_\eta}{2\pi \eta L} \int^{R}_{\infty}\cfrac{dr}{r^3}=  \omega_0\]Write the final expression:

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[M_{\eta}=-4\pi\omega_0\eta LR^2\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[E_{cr}=\sqrt{\dfrac{\alpha\eta}{4\pi\varepsilon_0^2}\dfrac{(\lambda_1+\lambda_2)^2}{(\varepsilon_1\lambda_2-\varepsilon_2\lambda_1)}}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\omega_0=\dfrac{\sqrt{\dfrac{(\varepsilon_1\lambda_2-\varepsilon_2\lambda_1)\varepsilon_0^2E_0^2}{\eta}-(\lambda_1+\lambda_2)^2}}{\varepsilon_0(\varepsilon_1+\varepsilon_2)}\]
\end{solcard}
