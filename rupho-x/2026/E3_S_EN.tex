...
\par\smallskip\noindent\textbf{Answer:} \[OOO~00~00\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[f_{\max} = 1.999860 ~\mathrm{MHz}.\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[\dfrac{U_{\text{CH}2}}{U_{\text{CH}1}}=0.733.\]
\end{solcard}
...
\begin{solcard}{A5}{From the plotted graph $|Z|(f)$, find the frequencies $f_{res}$ and $f_\text{anti}$ at which $|Z|$ is maximum and minimum, respectively.}{0.10}
\par\smallskip\noindent\textbf{Answer:} \[f_{res} = 1.999850~\mathrm{MHz}; \quad f_\text{anti} = 1.999740~\mathrm{MHz}.\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} Thus: \[\omega_s = \sqrt{\dfrac{1}{LC}};\quad \omega_p = \sqrt{\dfrac{1}{LC}\left(1+\dfrac{C}{C_0}\right)}; \quad \alpha = \dfrac{R}{L}.\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \[ |Z|^2 = \dfrac{(\omega_s^2 - \omega^2)^2 + (\omega_p \alpha)^2}{(\omega_p C_0)^2 ((\omega_p^2 - \omega^2)^2 + (\omega_p \alpha)^2)} .\]
\end{solcard}

\begin{solcard}{A8}{Using the approximations described above, express $f_{res}$ and $f_\text{anti}$ in terms of $\omega_s, \omega_p$.}{0.20}
...
\par\smallskip\noindent\textbf{Answer:} \[f_{res} = \dfrac{\omega_p}{2\pi}; \quad f_\text{anti} = \dfrac{\omega_s}{2\pi}\]
\end{solcard}

\begin{solcard}{A9}{Remove the dependence of the resonance frequencies $f_{res}$ and antiresonance $f_\text{anti}$ of the quartz resonator on the external capacitance $C_{\text{ext}}$. As an external capacitance $C_{\text{ext}}$, it is enough to use each of the provided capacitors separately, without combining them.}{0.45}
\par\smallskip\noindent\textbf{Answer:} $C_{\text{ext}}$, pF $f_{res}$, MHz $f_\text{anti}$, MHz 0 1.999850 1.999750 6.0 1.999842 1.999755 15 1.999832 1.999755 10 1.999837 1.999755 27 1.999822 1.999755 33 1.999816 1.999755 47 1.999807 1.999755 56 1.999804 1.999755 68 1.999798 1.999755 82 1.999794 1.999755
\end{solcard}

\begin{solcard}{A10}{Construct a linearized graph of $C_{\text{ext}}$ versus $f_{res}$ and $f_\text{anti}$.}{0.80}

Let us write the expression for the resonant frequency of a quartz resonator with a parallel connection $C_{\text{ext}}$: \[\omega_p(C_{\text{ext}}) = \sqrt{\dfrac{1}{LC}\left(1+\dfrac{C}{C_0+C_{\text{ext}}}\right)} = \omega_s\sqrt{1+\dfrac{C}{C_0+C_{\text{ext}}}}\]Then after the transformation we can obtain linearization: \[C_{{ext}} = \dfrac{f_\text{anti}^2 C}{f_{res}^2 - f_\text{anti}^2} - C_0\]
