...
\problembox{B4}{Find $\omega_{\text{к}}$ after the hit. Express your answer in terms of $v_0$, $L$, $\varphi$ and $k$.}{1.20}

\problembox{B5}{Find the velocity of point $A$ of rod $v_{A\text{к}}$ immediately after the impact. Express your answer using $v_0$, $\varphi$ and $k$.}{0.30}
...
\problembox{C3}{Find $v_{x\text{к}}$ after the hit. Express your answer in terms of $v_0$, $\mu$, $\varphi$ and $k$.}{1.40}

\problembox{C4}{Find the work done by the friction force $A_{\text{тр}}$ during the impact. Express your answer in terms of $m$, $v_0$, $\mu$, $\varphi$ and $k$.}{1.00}
