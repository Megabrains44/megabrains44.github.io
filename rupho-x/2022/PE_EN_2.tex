...
\problembox{C1}{Precisely calculate 30 pairs of points $(\varphi, \lambda)$ through which the magnetic line piercing points $\varphi=\pm 50^\circ$, $\lambda=0$ will pass at time $t=150~\text{}$.}{1.70}
...
\problembox{D1}{Using the $\sin \psi \approx 1 $ approximation, find $B_\text{}$.}{2.70}
