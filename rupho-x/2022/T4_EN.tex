...
\problembox{A1}{What is the speed of the satellites $v$ at the moment of launch? Express your answer in terms of $G$, $М_З$ and $R_З$.}{0.40}

\problembox{A2}{At what distance from the center of the Earth $R_0$ is the point $P$ of intersection of the satellite trajectories? Express your answer using $R_\text{З}$.}{0.60}

\problembox{A3}{What is the angle $\varphi$ between the directions of satellite velocities at point $P$?}{0.80}

\problembox{A4}{Find the time $t_0$ after which the satellites reach point $P$. Express your answer using $G$, $R_\text{З}$ and $M_\text{З}$.}{1.50}
...
\problembox{B3}{Find $\tau$. Express your answer in terms of $G$, $M_2$, $M_3$ and $R_\text{З}$.}{2.30}
