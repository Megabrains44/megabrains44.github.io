...
\begin{solcard}{A1}{Let the total number of moles of carbon dioxide gas in a closed bottle be $\nu_0 = 0.05$ mol, the volume of liquid $V_L =250$ ml, and the volume of gas $V_G = 5$ ml. Find the pressure $P$ of carbon dioxide in the bottle. Please also provide a numerical value. \textbackslash{}textbf{In further paragraphs, assume that the liquid is in an open container.}}{0.80}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ P = \frac{\nu_0 R T}{V_G + k_H V_L RT} \approx 5.4 \cdot 10^5~\text{Pa} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ R^* = \frac{2 \gamma k_H}{c - k_H P_0} $$ $$ c = k_H\left( P_0+\frac{2 \gamma}{R^*}\right) \approx  61 \frac{\mathrm{mol}}{м^3} $$
\end{solcard}

\begin{solcard}{A3}{Using the above considerations, find the diffusion coefficient $B$. Express your answer in terms of $k_B$, $T$, $\beta$. Determine the mobility of molecules $\beta$ in terms of viscosity $\eta$ and the size of the molecules. Find the numerical value of the diffusion coefficient.  \textbackslash{}textbf{If you fail to solve this item, you can use the value} $B = 5 \cdot 10^{-9} \text{m}^2/\text{s}$ to obtain numerical answers in the future.}{1.00}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ B = \frac{k_B T}{6 \pi \eta r} \approx 1.4 \cdot 10^{-9} м^2/c $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ D  =  \sqrt{\frac{2f_1}{3\kappa f_2} \frac{RT}{P}B(c-c_i) t} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ f_1 = \frac{\pi }{2} \left(1 + \cos \theta  \right) $$ $$ f_2 = \frac{\pi}{24}\left(2 + 3\cos \theta -  \cos^3 \theta \right) $$
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ R = \left(\frac{3 a_d \gamma \sin \theta}{2\rho g} \right)^{1/3} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ t_n =  \frac{P}{RT} \frac{h D_m}{B(c-c_n)} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} Dependence in coordinates $1/t_g$ on $1/t_n$.
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ U = \frac{2 \rho g}{9 \eta}a^2 $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ \frac{da}{dt} =  0.38 B^{2/3} \left(\frac{ \rho g}{ \eta}\right)^{1/3} \frac{RT}{P} \Delta c $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ N = 0.093\left( \frac{\rho g }{B \eta} \right)^{2/3} \frac{\pi \xi^2}{4} \ln \frac{c - k_H P_0}{c_n - k_H P_0} \approx 1.1 \cdot 10^7 $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ H = \frac{RT}{P} (c_n - k_H P_0) h \ln \frac{c - k_H P_0}{c_n - k_H P_0} \approx 0.53 h \approx 9 ~cm $$
\end{solcard}
