...
The theoretical current-voltage characteristic of the electrolytic bath within the framework of this model has the form \textbackslash{}rho $  и  $r_k$ .
...
\begin{solcard}{A3}{Estimate the magnitude of the contact potential difference $U_\text{к}$.}{1.00}
...
\begin{solcard}{A4}{Determine the value of contact resistance $r_\text{к}$.}{2.50}
