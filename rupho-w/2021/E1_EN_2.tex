...
When bodies roll, a special type of friction force occurs, called rolling friction. The existence of this type of friction is evidenced by the following fact. If a cylinder rolls along a horizontal plane without sliding (Fig. 1), then the speed of movement of the cylinder decreases, and this is not associated with the occurrence of sliding. Since the speed of the center of gravity $C$ of the cylinder decreases, it means that the cylinder is acted upon by an external force directed against the movement - the friction force $F_\text{tr}$. But the moment of this force relative to the pole $C$ should increase the angular velocity of rotation of the cylinder, since it is directed in the same direction as the rotation.
...
The moment $M$ (relative to point $A$) of the rolling friction force is proportional to the force of the normal reaction of the support $N$, equal in modulus to the force of gravity: $$M = kN.$$ The constant value $k$ is called the rolling friction coefficient. The moment of the rolling friction force is always directed so as to reduce the angular velocity of rotation of the cylinder. It should be noted that the horizontal friction force $F_\text{tr}$ is applied to the cylinder at the point of contact with the plane, which has zero velocity. Therefore, the force $F_\text{tr}$ does not perform mechanical work.
...
\begin{enumerate}
    \item Cylinder
    \item Piece of adhesive tape ($\times 3$)
    \item Wooden block
    \item Wooden ruler
    \item Metal ruler
    \item White A4 sheet ($\times 2$) with masking tape (not shown in photo)
\end{enumerate}
