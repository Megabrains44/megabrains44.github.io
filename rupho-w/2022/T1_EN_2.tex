...
It can be shown that the dependence of the displacement of the plate $x(t)$ on time has the following form $$x(t) = A e^{at} + B e^{-at} + C,$$ where $a$ depends only on $\mathcal{E}$, $S$, $d$, $q$ and $m$, while $A$, $B$ and $C$ are determined by the initial conditions.
...
\textit{Useful integrals:} $$\int\frac{dx}{ax+b} = \frac{1}{a}\ln(ax+b) + C, \qquad \int e^{ax}\,dx = \frac{e^{ax}}{a} + C.$$
