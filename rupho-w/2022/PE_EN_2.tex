...
For one mole of some nonideal gas, the dependence $T(V)$ on the isobar $p=2~M$ was removed. The data table is provided in the answer sheet. The relationship is slightly non-linear, and your task will be to find a suitable model to describe it.
