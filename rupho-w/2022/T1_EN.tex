...
$\textit{Примечание}$ : $$\textbackslash\{\}int\textbackslash\{\}frac\{dx\}\{ax+b\}=\textbackslash\{\}frac\{1\}\{a\}\textbackslash\{\}ln\textbackslash\{\}left(ax+b\textbackslash\{\}right)+C $$ $$\textbackslash\{\}int e^\{ax\}dx=\textbackslash\{\}frac\{e^\{ax\}\}\{a\}+C $$
