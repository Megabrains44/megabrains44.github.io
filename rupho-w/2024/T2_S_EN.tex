...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$r_0 = 4 R, \quad \mathcal{E}_0 = \frac{2}{5} \mathcal{E} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ I_{AB} = \begin{cases} \frac{2 \mathcal{E} I_0}{5 (U_0 + 5R I_0)},  \quad \mathcal{E} \le \frac{5}{2} \left(U_0  + 5 R I_0 \right);\\ I_0, \quad \mathcal{E} > \frac{5}{2} \left(U_0  + 5 R I_0 \right). \end{cases} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ P_{\text{н.э.}} = \begin{cases} U_0 I_0 \cfrac{4 \mathcal{E}^2}{25 (U_0 + 5 R I_0)^2}, \quad  \mathcal{E} \le \frac{5}{2} \left(U_0  + 5 R I_0 \right);\\ I_0 \left( \frac{2}{5} \mathcal{E} - 5 I_0 R\right),  \quad  \mathcal{E} > \frac{5}{2} \left(U_0  + 5R I_0 \right). \end{cases} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ I_C = \frac{\mathcal{E}}{R + U_0/I_0} e^{- \frac{t}{C(R + U_0/I_0)}} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ t = \frac{\ln 5}{2} t_0 =  \frac{\ln 5}{2} C \left(R + \frac{U_0}{I_0}\right) = 0.0804~\mathrm{s} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$ I_C = \begin{cases} I_0, \quad t \le \frac{C}{I_0} (\mathcal{E} - U_0 - R I_0 );\\ I_0 \exp\left(- \dfrac{t- C(\mathcal{E}-U_0 - R I_0)/I_0}{C(R + U_0/I_0)}\right), \quad t >\frac{C}{I_0} (\mathcal{E}  -U_0- R I_0 ). \end{cases} $$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$Q = Q_1 + Q_2  = \frac{C}{2} \left( (\mathcal{E} - I_0 R)^2  - U_0^2\right) + \frac{C}{2} U_0 (U_0 + I_0 R)  =  \frac{C}{2} \left((\mathcal{E} - I_0 R)^2 + U_0 I_0 R \right) = 3.7~\mathrm{mJ}$$
\end{solcard}
