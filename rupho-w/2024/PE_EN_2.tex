...
Fig. 1 -- Characteristic type of dependence $L(T)$
...
As you may have noticed, the specific heat of evaporation of a liquid decreases with increasing temperature, going to zero at a temperature above the critical one. Thus, the liquid-vapor transition at a temperature above the critical temperature would not imply a change in the interaction energy of molecules, i.e. liquid will be no different from steam. This state of matter at temperatures above $T_\mathrm c$ is called supercritical fluid. Moreover, at temperatures below $T_\mathrm c$, liquid and vapor are different phases of the substance. In coordinates $(p,T)$ (see Fig. 2), the boundary between them actually represents the saturated vapor pressure curve $p_\text{sat}(T)$. The saturated vapor pressure satisfies the Clapeyron-Clausius equation \[\frac{\mathrm dp_\text{sat}}{p_\text{sat}}=\frac{\mu L}{R}\frac{\mathrm dT}{T^2},\]where $\mu$ is the molar mass of the substance $\big($for water $\mu_\text{}=18.0~\frac{\text{g}}{\text{mol}}\Big)$, $R=8.314~\frac{\text{J}}{\text{mol}\cdot\text{K}}$ is the universal gas constant. Point $(p_\text{sat}(T_\mathrm c),T_\mathrm c)$ is called the critical point of the substance. In this part we will try to estimate the pressure $p_\mathrm c=p_\text{sat}(T_\mathrm c)$ at the critical point.

This state of matter at temperatures above $T_\mathrm c$ is called supercritical fluid. Moreover, at temperatures below $T_\mathrm c$, liquid and vapor are different phases of the substance. In coordinates $(p,T)$ (see Fig. 2), the boundary between them actually represents the saturated vapor pressure curve $p_\text{sat}(T)$. The saturated vapor pressure satisfies the Clapeyron-Clausius equation \[\frac{\mathrm dp_\text{sat}}{p_\text{sat}}=\frac{\mu L}{R}\frac{\mathrm dT}{T^2},\]where $\mu$ is the molar mass of the substance $\big($for water $\mu_\text{}=18.0~\frac{\text{g}}{\text{mol}}\Big)$, $R=8.314~\frac{\text{J}}{\text{mol}\cdot\text{K}}$ is the universal gas constant.

The point $(p_\text{sat}(T_\mathrm c),T_\mathrm c)$ is called the critical point of the substance. In this part we will try to estimate the pressure $p_\mathrm c=p_\text{sat}(T_\mathrm c)$ at the critical point.

Fig. 2 -- Phase diagram of water in coordinates $(p,T)$
...
\problembox{B5}{Express the pressure $p_\mathrm c$ at the critical point in terms of $S$ and calculate it to three significant figures if the pressure is $p_\text{sat}(100~{}^\circ\mathrm C)=1.013\cdot10^5~\text{Pa}$.}{0.70}
