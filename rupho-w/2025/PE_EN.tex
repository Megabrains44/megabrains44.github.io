...
\problembox{A3}{The answer sheet contains a life-size photograph of the bubble. Find the area of ​​the object on the wall as accurately as possible. Numerical value $L=1~м$. Note: It is convenient to represent the answer as the area under some graph. Graph paper for graphing is provided in the answer sheet.}{2.50}
...
\problembox{B2}{To ensure that the dependence does not diverge at $x=16~cm$, it is convenient to multiply it by some function $f(x)$, which at this point turns into $0$. Please suggest this feature. Recount the points for $f(x)S(x)$.}{1.00}
...
\problembox{B3}{Obtain the extrapolated value of $C=f(x)S(x)$ at point $x=16~cm$. Note: Please note that the relationship may not be linear around this point}{1.00}
