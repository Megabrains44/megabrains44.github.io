...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} The equation is applicable over the entire range ($n_w \in [0, 1]$).
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $T_g=(140.3+35.272\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w}-3.879(\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w})^2+23.467(\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w})^3)K\approx 162.8~K$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} \[T_0=92.5~\mathrm{K}\]\[D=16.9\]
\begin{figure}[H]
  \centering
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $\eta_t=6.8~мПа\cdot \mathrm{s}$
\end{solcard}

\begin{solcard}{C3}{Compare your results. If there are discrepancies, explain the reason for them.}{0.20}
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} Considering that the measurement range is large, the results can be considered coincident. The slight difference is most likely due to inaccurate temperature measurements, since the dependence of viscosity on temperature is very strong.
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} \[\eta_{max}=1.400~\mathrm{Pa}\cdot \mathrm{s}\]
\end{solcard}
