...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$U=C_0T+\dfrac{aT^2}{2}$$
\end{solcard}

\begin{solcard}{A2}{What is the heat capacity of gas $C_P$ at constant pressure at a given temperature $T$?}{0.30}

According to Mayer's equation: $$C_P =C_V+R\cdot 1~\mathrm{mol}$$here and further мы опускаем множитель $1~mol$ in all expressions. From here we get:

\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[C_P=C_0+aT+R\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[Q_V=\dfrac{C_0(p_2-p_1)V}{R}+\dfrac{a(p_2^2-p_1^2)V^2}{2R^2}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $$Q_P=\dfrac{(C_0+R)(V_2-V_1)p}{R}+\dfrac{a(V_2^2-V_1^2)p^2}{2R^2}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[\eta=\dfrac{2}{33}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[(C_0+aT)\mathrm dT+\dfrac{RT}{V}\mathrm dV=0\]
\end{solcard}

\begin{solcard}{A7}{From the relation in the previous paragraph, obtain an adiabatic equation connecting $T$ and $V$ of the form $$ f(T, V) = \mathrm{const}, $$into the function $f$ могут also входить $C_0$, $a$, $R$.}{0.90}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[f(T, V)=C_0\operatorname{ln}T+R\operatorname{ln}V+aT=\operatorname{const}\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[V_3=V_2\left(\dfrac{T_+}{T_-}\right)^\frac{C_0}{R}\exp\left[\dfrac{a(T_+-T_-)}{R}\right]\]\[V_4=V_1\left(\dfrac{T_+}{T_-}\right)^\frac{C_0}{R}\exp\left[\dfrac{a(T_+-T_-)}{R}\right]\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The efficiency of the cycle coincides with the efficiency of the Carnot cycle.
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[Q_V=\dfrac{21}{4}RT_1\]
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[Q_P=\dfrac{31}{4}RT_1\]
\end{solcard}

\begin{solcard}{B3}{Let the initial volume of gas be $V_0$. What will the final volume be equal to if the temperature was increased adiabatically? Find the work done in this process. Express your answers using $T_1$, $R$, $V_0$.}{1.80}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[V=\dfrac{V_0\sqrt{2}}{9e\sqrt{3}}\]\[A=-\frac{21}{4}RT_1\]
\end{solcard}
