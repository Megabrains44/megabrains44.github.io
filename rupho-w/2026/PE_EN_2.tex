...
\begin{itemize}
    \item Density of glycerol $\rho_g = 1260~\mathrm{kg/m^3}$;
...
\end{itemize}
In all parts of the problem you may take the volume of the mixture to be equal to the sum of the volumes of the components that make up the mixture.
...
If the molar concentration of water in the mixture is sufficiently small, we may assume that $a\cdot\exp(b n_w) \ll 1$. Therefore, to simplify the analysis of the above dependence, we propose to use the approximation valid only for small molar concentrations of water:
\[\eta = \xi\cdot\exp(-k n_w).\]
The table in the answer sheets shows the experimental dependence of the viscosity of a mixture of glycerol and water on the glass transition temperature. The measurements were carried out at a temperature of $T = 25~^\circ\mathrm{C}$.
