...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$\vec r(t) = \frac{\vec g t}{\varepsilon}+\left(\vec v_0-\frac{\vec g}{\varepsilon}\right) \frac{1-e^{-\varepsilon t}}{\varepsilon}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$P = \varepsilon m \left(\frac{g^2\left(1-e^{-\varepsilon t}\right)^2}{\varepsilon^2} + v_0^2 e^{-2\varepsilon t}+\frac{2 \left(\vec v_0, \vec g\right)}{\varepsilon}\left(1-e^{-\varepsilon t}\right) e^{-\varepsilon t}\right)$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$P =  \frac{F_0^2\varepsilon}{m\left(\varepsilon^2+\omega^2\right)}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$z(t) = -\frac{gt}{\varepsilon}+\frac{g\left(1-e^{-\varepsilon t}\right)}{\varepsilon^2}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$\begin{cases} \ddot{x}=\varepsilon\left(-\omega y - \dot x\right)\\ \ddot y =\varepsilon\left(\omega x - \dot y\right) \end{cases}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$\begin{cases} a^2 - \Omega^2 = -\varepsilon a\\ 2a\Omega = \varepsilon\omega - \varepsilon\Omega \end{cases}$$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} For $\varepsilon \ll \omega$: $$a_1 = -\sqrt{\frac{\omega\varepsilon}{2}}=\Omega_1$$$$a_2 = \sqrt{\frac{\omega\varepsilon}{2}}=\Omega_2$$For $\varepsilon \gg \omega$: $$a_1 = -\varepsilon$$$$a_2 = 0$$$$\Omega_1 = -\omega$$$$\Omega_2 = \omega$$
\end{solcard}

\begin{solcard}{B6}{An arbitrary solution to the system of equations has the form $$\left(x(t), y(t)\right) = A\vec r_{11}+B\vec r_{12}+C\vec r_{21}+D\vec r_{22}.$$ Use initial condition, lead to in introduction to part,  express $A$, $B$, $C$ and $D$ through $r_0$, $a_1$, $a_2$, $\Omega_1$ and $\Omega_2$.}{1.50}
...
\par\smallskip\noindent\textbf{Answer:} \textbf{Answer:} $$P = \left(\vec F, \left[\vec\omega, \vec r\right]-\vec v\right) = \varepsilon m v_\text{rel}^2 = \varepsilon m \left(v_z^2+\left(v_x+\omega y\right)^2+\left(v_y-\omega x\right)^2\right)$$
\end{solcard}
