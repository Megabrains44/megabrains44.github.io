...
\problembox{A7}{From the relation in the previous paragraph, obtain an adiabatic equation connecting $T$ and $V$ of the form $$f(T, V) = \mathrm{const};$$ the function $f$ may also contain $C_0$, $a$, $R$.}{0.90}
