...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The dependence $\operatorname{ln}\dfrac{\eta}{1~\mathrm{Pa}\cdot с}(n_w)$ is linear.
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} The dependence $\operatorname{ln}|\dfrac{\xi \operatorname{exp}(-kn_w)}{\eta}-1|(n_w)$ is linear.
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} $T_g=\left(140.3+35.272\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w}-3.879\left(\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w}\right)^2+23.467\left(\dfrac{\rho_gc_g}{(\rho_g-\rho_w)c_g+\rho_w}\right)^3\right)~\mathrm{K}\approx 162.8~\mathrm{K}$
\end{solcard}
...
\par\smallskip\noindent\textbf{Answer:} \textbackslash{}textbf{Answer:} \[T_0=255~\mathrm{K}\]\[D=0.18\]
\begin{figure}[H]
  \centering
